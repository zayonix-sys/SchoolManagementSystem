            ...
            <form onSubmit={handleSubmit(onSubmit, handleError)}>
              <div className="grid grid-cols-6 gap-4 mt-5">
                ...
                <div className="col-span-6">
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    {subject.map((sub) => (
                      ...
                      >
                        <Checkbox
                          variant="filled"
                          id={`subject-${sub.subjectId !== undefined ? sub.subjectId : 0}`}
                          value={sub.subjectId !== undefined ? sub.subjectId : 0}
                          onChange={(e) =>
                            handleCheckboxChange(
                              sub.subjectId !== undefined ? sub.subjectId : 0,
                  ...
                  {errors.subjectIds && (
                    <p className="text-destructive">{errors.subjectIds.message}</p>
                  )}
                </div>

...
// const ViewTimeTable: React.FC<ViewTimeTableProps> = ({ className, subjectData, periodsData }) => {
...
//   // Get unique periods for creating table headers
//   const periods = getUniquePeriods(timeTable);

//   // const periods = getUniquePeriods(timeTable);

//   const groupedByDay = groupByDayOfWeek(filteredTimeTable);
//   const sortedDays = sortDaysOfWeek(Object.keys(groupedByDay));
...
//           {sortedDays.map((day) => (
//             <TableRow key={day}>
//               <TableCell className="sticky left-0 bg-background drop-shadow-md font-bold">
//                 {day}
//               </TableCell>
...
//                         <div>{periodEntry.startTime}</div>
//                         <div>{periodEntry.endTime}</div>

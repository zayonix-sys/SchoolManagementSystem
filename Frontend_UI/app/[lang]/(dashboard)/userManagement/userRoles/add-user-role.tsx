...
import { useAddUserRoleMutation } from "@/services/apis/userRoleService";
...
const AddUserRole: React.FC<UserRoleProps> = ({ refetch }) => {
  ...
  const onSubmit: SubmitHandler<UserRoleFormValues> = async (data) => {
    try {
      ...
      if (response?.data?.success) {
        const roleName = Array.isArray(response?.data?.data)

...
const AddUser: React.FC<UserListTableProps> = ({ campuses, userRole }) => {
            ...
            <form onSubmit={handleSubmit(onSubmit, handleError)}>
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="col-span-2 lg:col-span-1">
                  <Select onValueChange={(value) => setValue("roleId", parseInt(value))}>
                    <SelectTrigger>
                ...
                <div className="col-span-2 lg:col-span-1">
                  ...
                  {errors.passwordHash && (
                    <p className="text-destructive">{errors.passwordHash.message}</p>
                  )}
                </div>

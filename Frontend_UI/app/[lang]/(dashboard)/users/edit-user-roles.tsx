...
import { updateUserRole, UserRoleData } from "@/services/userRoleService";
...
export default function EditUserRoles({ userRoleData }: { userRoleData: UserRoleData }) {
  const { roleId, roleName, roleDescription } = userRoleData;

  const { register, handleSubmit, reset, formState: { errors } } = useForm<UserRoleFormValues>({
